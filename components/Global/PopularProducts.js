            ...
            <View style={styles.container}>
                ...
                <View style={styles.main}>
                    ...
                    <View style={styles.rowSpace}>
                        ...
                        <Text style={{color:'black',fontSize:17,fontWeight:'bold',paddingTop:10}}> Popular Products </Text>
                        {props.n ===100 ?
                            <Text> </Text>
                        :
                        <Text style={{color:'red',paddingTop:10}} onPress={()=>navigation.navigate('PopularProductsPage')}> see all </Text>
                        }
