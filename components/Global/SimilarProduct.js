            ...
            <View style={styles.container}>
                ...
                <View style={styles.main}>
                    ...
                    <View style={styles.rowSpace}>
                        ...
                        <Text style={{color:'black',fontSize:17,fontWeight:'bold',paddingTop:10}}> Similar Products  </Text>
                        {props.n ===100 ?
                            <Text> </Text>
                        :
                        <Text style={{color:'red',paddingTop:10}} onPress={()=>navigation.navigate('BestSellingPage')}> see all </Text>
                        }
                            ...
                            return (
                                <ScrollView key={index+1}>
                                    ...
                                    <TouchableOpacity key={index} onPress={()=> navigation.navigate('ProductDetailsPage',{item,value:props.value})}>
                                        <View style={styles.fram} key={index+2}>
